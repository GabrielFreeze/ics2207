...
while cap.isOpened():
    ...
    if ret:
        ...
        face_cascade = cv2.CascadeClassifier('cascade\haarcascade_frontalface_default.xml') #Load Face Classifier
        eye_cascade = cv2.CascadeClassifier('cascade\haarcascade_eye.xml')                  #Load Eye Classifier
